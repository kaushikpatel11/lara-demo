...
<html>
  <head>
    ...
    <title>Agent Profile Approved</title>
    <meta name="Description" content="" />
    ...
    <table cellspacing="0" cellpadding="0px" width="600px" align="center" style="background-color: #080522;">
                ...
                <table cellspacing="0" cellpadding="0px" width="100%" style="color: #ffffff; border-bottom: 1px solid #64FECC;">
                    <tr>
                        ...
                        <td style="padding:10px 20px;" width="70%">
                            <h2 style="font-weight: bold; color: #64FECC; font-size: 20px; text-align: right;">Request Accepted</h2>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding:20px 30px;min-height:300px; vertical-align: top;">
                ...
                <p style="color:#ffffff">{{$user['fname']}}  {{$user['lname']}} has Approved the management access to {{$ReqData->agentBand->name}}'s demo profile.</p>
            </td>
        </tr>
        <!-- Footer Section -->
        <tr>
