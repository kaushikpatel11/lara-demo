...
<html>
  <head>
    ...
    <title>Invitation from the demo</title>
    <meta name="Description" content="" />
    ...
    <table cellspacing="0" cellpadding="0px" width="600px" align="center" style="background-color: #080522;">
                ...
                <table cellspacing="0" cellpadding="0px" width="100%" style="color: #ffffff; border-bottom: 1px solid #64FECC;">
                    <tr>
                        ...
                        <td style="padding:10px 20px;" width="70%">
                            <h2 style="font-weight: bold; color: #64FECC; font-size: 20px; text-align: right;">Invitation from the demo </h2>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding:20px 30px;min-height:300px; vertical-align: top;">
                <h3 style="font-size: 18px;margin-bottom: 10px; color:#ffffff">Hey there,</h3>
                <p style="color:#ffffff">{{$user['fname']}}  {{$user['lname']}}, Invited you to Create a Talent Profile with the demo</p>
